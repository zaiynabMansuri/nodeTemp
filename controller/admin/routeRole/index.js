...
const getRouteRoleByAggregateUsecase = require('../../../use-case/routeRole/getRouteRoleByAggregate')({ routeRoleDb });
...
const getRouteRoleByAggregate = routeRoleController.getRouteRoleByAggregate(getRouteRoleByAggregateUsecase);
