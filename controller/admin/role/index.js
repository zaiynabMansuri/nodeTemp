...
const getRoleByAggregateUsecase = require('../../../use-case/role/getRoleByAggregate')({ roleDb });
...
const getRoleByAggregate = roleController.getRoleByAggregate(getRoleByAggregateUsecase);
