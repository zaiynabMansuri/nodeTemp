...
const getUserRoleByAggregateUsecase = require('../../../use-case/userRole/getUserRoleByAggregate')({ userRoleDb });
...
const getUserRoleByAggregate = userRoleController.getUserRoleByAggregate(getUserRoleByAggregateUsecase);
