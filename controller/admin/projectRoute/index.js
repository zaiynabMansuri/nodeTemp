...
const getProjectRouteByAggregateUsecase = require('../../../use-case/projectRoute/getProjectRouteByAggregate')({ projectRouteDb });
...
const getProjectRouteByAggregate = projectRouteController.getProjectRouteByAggregate(getProjectRouteByAggregateUsecase);
